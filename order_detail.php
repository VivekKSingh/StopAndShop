...
<div id="main_container">
   ...
   <label><a href="index.php">Home</a></label> >
	  <label><a href="orders.php">Orders</a></label> >
	  <span class="currentlc">Order Details</span> 
   ...
   <?php
	...
	include "dbconnect.php";
			...
			$query = "select o.orderID,name,o.price,o.quantity,timestamp,o.productID,shipaddress,description from product p, orders o where o.productID=p.productID and o.orderID = '$order'";
			//echo $query;
...
?>	
      <div class="center_contentlc">
   	<div class="center_title_barlc">Order Detail</div>
   ...
   <center> <span class="bluelc">Order Detail</span> </center>
   <table>
<tr>
...
<td align="left"><?php echo $price*$quantity;?></td>
</tr>
<tr>
  <td align="left"> <span class="bluelc">Description</span></td>
