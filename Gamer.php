...
<div id="main_container">
   ...
   <div id="main_content"> 
    ...
    Navigation: <span class="currentlc">Home</span> >
				...
				<label ><a href="Gamer.php">  Gamers</a></label>
...
if(isset($_POST["prev"]))
{
	...
	$query ="SELECT * FROM $_TABLE_NAME INNER JOIN $_TABLE_NAME2 ON $_TABLE_NAME.productId = $_TABLE_NAME2.productId and $_TABLE_NAME2.CATEGORY='LAPTOP' and
		$_TABLE_NAME.type='Gaming' LIMIT ".(($currentPage-1)*$numPerPage).",$numPerPage";
}
else
{
	if(isset($_POST["next"]))
	...
	else
	{
		...
		$currentPage = 1;
		$query ="SELECT * FROM $_TABLE_NAME INNER JOIN $_TABLE_NAME2 ON $_TABLE_NAME.productId = $_TABLE_NAME2.productId and $_TABLE_NAME2.CATEGORY='LAPTOP' and
		$_TABLE_NAME.type='Gaming' LIMIT 0,$numPerPage";
	}
}
...
if(isset($_POST["prev"]))
{
	...
	?>
	<div class="center_title_barlc">"Gaming" <?php echo $numRecord;?> results found.</div>
	<?php
	for ($i = 0; $i < $num; $i++) {
