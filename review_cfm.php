...
else
{
 ...
 //Session
 //$ratecmt = 1;
 $ratecmt = (int)($_SESSION["ratecmt"]);
 if ($ratecmt==1)
 {
 include "dbconnect.php";
 $query2 = "INSERT INTO rate (`productID`, `customerID`, `rating`, `review`) VALUES('$prodID','$customerID','$rate','Good Product')";
 mysql_query($query2);
 $_SESSION["ratecmt"] = 2;
?>
...
<div id="main_container">
   ...
   <div class="center_content">
	 ...
	 <div class="product_title_big"><center>THANKS FOR YOUR RATING!</center></div>
         <a style="float:right" href="index.php" >Continue</a> 			
...
{ ?>
	...
	<div class="product_title_big"><center><br><br><br><br><br>You have already rated this product!</center></div>
<?php }?>