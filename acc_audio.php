  ...
  <body>
          ...
          <div class="ofertalc">
            <div class="oferta_content">
              ...
              <div class="oferta_detailslc">
                ...
                <a href="#" class="detailslc">details</a>
              </div>
            </div>
	...
	<div id="menu_tab">
          ...
          <ul class="menulc">
                         ...
                         <li><a href='profile.php' class="nav4"> Welcome : <?php echo strtoupper($_SESSION["username"]);?> </a> <li>  
	...
	<div class="crumb_navigationlc">Navigation: 
	  ...
	  <label><a href="index.php">Home</label> >
	  <label><a href="acc_mouse.php?acc_type=Earphone">Accessories</a></label> 
	...
	<div class="left_contentlc">
	  ...
	  <ul class="left_menulc">
	    <li class="odd"><a>Accessories</a></li> 
		<li class="even"><a href="acc_mouse.php?acc_type=Earphone">Earphones</a></li>
		<li class="even"><a href="acc_mouse.php?acc_type=power">Battery/Power</a></li>
		<li class="even"><a href="acc_mouse.php?acc_type=USB Drive">USB Drive</a></li>
		<li class="even"><a href="acc_mouse.php?acc_type=case">Carrying Cases</a></li>
		<li class="even"><a href="acc_mouse.php?acc_type=mice">Keyboard/Mouse</a></li>
		<li class="even"><a href="acc_mouse.php?acc_type=Hard Drive">Memory/Storage</a></li>
	  </ul>
	</div> 
	<!-- end of left content -->
...
if(isset($_POST["prev"]))
{
	...
	$query ="SELECT * FROM $_TABLE_ACC INNER JOIN $_TABLE_NAME2 ON $_TABLE_ACC.productId = $_TABLE_NAME2.productId and $_TABLE_NAME2.CATEGORY='Accessory' and
		$_TABLE_ACC.type='Earphone' LIMIT ".(($currentPage-1)*$numPerPage).",$numPerPage";
}
else
{
	if(isset($_POST["next"]))
	...
	else
	{
		...
		$currentPage = 1;
		$query ="SELECT * FROM $_TABLE_ACC INNER JOIN $_TABLE_NAME2 ON $_TABLE_ACC.productId = $_TABLE_NAME2.productId and $_TABLE_NAME2.CATEGORY='Accessory' and
		$_TABLE_ACC.type='Earphone' LIMIT 0,$numPerPage";
	}
}
...
if(isset($_POST["prev"]))
{
	...
	?>
   	  <div class="center_title_barlc">"Earphones" <?php echo $numRecord;?> results found.</div>
   	  <?php
		for ($i = 0; $i < $num; $i++) {
	  ...
	  <div class="prod_box_big"> 
	    <div class="center_prod_box_big"> 
	      ...
	      <?php $image = "images/headp2.jpg"?>
		<a href="details_acc.php?prodid=<?php echo $prodid;?>" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src=<?php echo $image;?> alt="" title="" border="0" /></a>
	      </div>
