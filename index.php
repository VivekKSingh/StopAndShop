...
<div id="main_container">
   ...
   <div class="center_contentlc">
   	<div class="center_title_barlc">Laptops For</div>
        <?php 
    	...
    	<div class="prod_boxlc">
            ...
            <div class="center_prod_boxlc">            
                 <div class="product_titlelc"><a href="home.php">Home</a></div>
                 <div class="product_imglc"><a href="home.php?>"><img src=<?php echo $imagepath;?> alt="" title="" border="0" /></a></div>
    	...
    	<div class="prod_boxlc">
        	<div class="top_prod_boxlc"></div>
            <div class="center_prod_boxlc">            
                 <div class="product_titlelc"><a href="business.php">Business</a></div>
                 <div class="product_imglc"><a href="business.php"><img src=<?php echo $imagepath;?> alt="" title="" border="0" /></a></div>
                 <div class="prod_pricelc"><span class="pricelc"><?php echo "$".$price;?></span></div>                     
            </div>
            <div class="bottom_prod_boxlc"></div> 
        </div>
    	...
    	<div class="prod_boxlc">
        	<div class="top_prod_boxlc"></div>
            <div class="center_prod_boxlc">            
                 <div class="product_titlelc"><a href="Gamer.php">Gaming</a></div>
                 <div class="product_imglc"><a href="Gamer.php"><img src=<?php echo $imagepath;?> alt="" title="" border="0" /></a></div>
                 <div class="prod_pricelc"><span class="pricelc"><?php echo "$".$price;?></span></div>                     
            </div>
            <div class="bottom_prod_boxlc"></div> 
        </div>
 ...
 <div class="center_title_barlc">Featured Laptops:</div>
        <?php 
        include "dbconnect.php";
        $query ="SELECT * FROM $_TABLE_NAME INNER JOIN $_TABLE_NAME2 ON $_TABLE_NAME.productId = $_TABLE_NAME2.productId and $_TABLE_NAME2.CATEGORY='LAPTOP' ";
        $result = mysql_query ($query);
        $num = mysql_numrows ($result);
        $numList = range(0,$num-1);
        shuffle ($numList);
        $rlist = array_slice($numList,0,6);
        for ($i = 0; $i < 6; $i++) {
         	
        		$name= mysql_result ($result, $rlist[$i], "name");
        		$prodid=mysql_result ($result, $rlist[$i], "productId");
        		$price= mysql_result ($result, $rlist[$i], "price");
        		$imagepath = mysql_result ($result, $i, "imagepath");
        ?>	
