...
<div id="main_container">
  ...
  <div class="center_contentlc">
   	<div class="center_title_barlc">Please enter your new address:</div>
    	...
    	<div class="prod_box_biglc">
			...
			<label class="contactlc"><strong>Street (Line One):</strong></label>
                     <input type="text" class="contact_inputlc" />
			
			</div> 
		 <div class="form_rowlc">
		<label class="contactlc"><strong>Street (Line Two):</strong></label>
                     <input type="text" class="contact_inputlc" />
			
			</div> 
		    		<div class="form_rowlc">
                    <label class="contactlc"><strong>City:</strong></label>
                    <input type="text" class="contact_inputlc" />
                    </div>  
                    <div class="form_rowlc">
                    <label class="contactlc"><strong>State:</strong></label>
                    <input type="text" class="contact_inputlc" />
                    </div>
                    <div class="form_rowlc">
                    <label class="contactlc"><strong>Zip Code:</strong></label>
                    <input type="text" class="contact_inputlc" />
            		</div> 
                    <div class="form_rowlc">
                    <label class="contactlc"><strong>Phone:</strong></label>
                    <input type="text" class="contact_inputlc" />
            		</div>
                    ...
                    <div class="form_rowlc">
                    <a href="details.php" class="applylc"></a>
                    </div>      
